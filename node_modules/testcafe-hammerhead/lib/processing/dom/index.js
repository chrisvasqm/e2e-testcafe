...
var URL_ATTRS = Object.keys(URL_ATTR_TAGS);
...
var IFRAME_FLAG_TAGS = function () {
    ...
    for (var _iterator = TARGET_ATTR_TAGS, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref;
...
var DomProcessor = function () {
    ...
    DomProcessor.processJsAttrValue = function processJsAttrValue(value, _ref2) {
        ...
        if (isJsProtocol) value = 'javascript:' + value;
    ...
    DomProcessor.getAttrsForCleaning = function getAttrsForCleaning() {
        var attrs = [];

        for (var _iterator2 = URL_ATTRS, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
            var _ref3;
    ...
    DomProcessor.prototype.getUrlAttr = function getUrlAttr(el) {
        ...
        for (var _iterator3 = URL_ATTRS, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
            var _ref4;
    ...
    DomProcessor.prototype._processJsAttr = function _processJsAttr(el, attrName, _ref5) {
        var isJsProtocol = _ref5.isJsProtocol,
            isEventAttr = _ref5.isEventAttr;
    ...
    DomProcessor.prototype._processTargetBlank = function _processTargetBlank(el) {
        var storedTargetAttr = DomProcessor.getStoredAttrName('target');
